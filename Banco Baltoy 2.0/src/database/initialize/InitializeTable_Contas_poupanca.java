...
public class InitializeTable_Contas_poupanca {
	
	private String tableName = "contas_poupanca";
	private static Database database;
	
	public InitializeTable_Contas_poupanca(Database database) {
		this.database = database;
		
		try {
			String codeSQL = "CREATE TABLE IF NOT EXISTS " + database.getDatabaseName() + "." + tableName + " (" + 
					"	`num_conta_poupanca` CHAR(19) CHARACTER SET utf8 COLLATE utf8_general_ci UNIQUE NOT NULL," + 
					...
					"    CONSTRAINT PK_Contas_corrente PRIMARY KEY(`num_conta_poupanca`)," + 
